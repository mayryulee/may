...
export function renderQuoteHtml(
  ...
  const stanzasContainerClass = isTheme02
    ? "space-y-5 text-[0.9rem] font-normal leading-[1.8] tracking-tight"
    : "space-y-5 text-[0.9rem] font-normal leading-[1.8] tracking-tight";
  ...
  const attributionClass = isTheme02
    ? "m-0 mt-10 text-[0.9rem] font-normal tracking-tight text-[#5D5D5D]"
    : "m-0 mt-10 text-[0.9rem] font-normal tracking-tight text-white/70";
